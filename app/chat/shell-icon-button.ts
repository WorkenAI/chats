...
import type { ShellAppearance } from "@/app/chat/shell-theme";

/** Header / sidebar icon buttons (matches `WorkspaceLayout`). */
export function shellHeaderIconClass(appearance: ShellAppearance): string {
  return cn(
