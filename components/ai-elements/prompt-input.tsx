...
export const PromptInputActionAddAttachments = ({
  ...
  const handleSelect = useCallback(
    (e: Parameters<DropdownMenuItemOnSelect>[0]) => {
      e.preventDefault();
...
export const PromptInputActionAddScreenshot = ({
  ...
  const handleSelect = useCallback(
    async (event: Parameters<DropdownMenuItemOnSelect>[0]) => {
      onSelect?.(event);
...
type InputGroupButtonOnClick = NonNullable<
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    (e: Parameters<InputGroupButtonOnClick>[0]) => {
